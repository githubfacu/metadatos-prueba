    ...
    <article className='flex flex-col text-primary gap-8 md:gap-12 lg:gap-16 self-center w-full items-center justify-center'>
        ...
        <div className='flex items-center justify-center w-screen md:w-auto gap-[5vw]'>
            ...
            >
                ...
                />
                <Link href={'/'} className='button-primary font-semibold md:text-xl px-4 whitespace-nowrap md:w-[300px] md:h-[64px] content-center'>
                    QUIERO DONAR
                </Link>
            </div>
            <div
            ...
            >
                <Image 
                    ...
                    className="w-[50px] h-[46px] md:w-[80px] md:h-[74px] lg:w-[117px] lg:h-[109px]"
                />
                <Link href={'/'} className='button-primary font-semibold md:text-xl flex items-center justify-center px-4 whitespace-nowrap md:w-[300px] md:h-[64px]'>
